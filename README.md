...
> To learn more about how to list the vid/pid, use this tools https://github.com/EmergingTechnologyAdvisors/node-serialport: npm install -g serialport   serialport-list -f jsonline
